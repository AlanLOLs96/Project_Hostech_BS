...
$hist_fetch_sql_stmt = "select * from outpass_details where admno = '".$inmate_details['admno']."' and warden_reject = 1 order by issue_date desc " ;
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title ">REJECTED OUTPASS HISTORY</h3>
			</div>
			<div class="panel-body">
				<table class="table table-striped" id="oprejectedtable">
					<thead>
						<tr>
							<th>OP#</th>
							<th>Issue Date</th>
